                    ...
                    <div class="footer__container clearfix">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6">
                            <div class="ft__widget">
                                <div class="ft__logo">
                                    <a href="index.html">
                                        <img src="<?= BASEURL ?>/images/logo/logo.png" alt="footer logo">
                                    </a>
                                </div>
                        ...
                        <div class="modal-product">
                            ...
                            <div class="product-images">
                                <div class="main-image images">
                                    <img alt="big images" src="<?= BASEURL ?>/images/product/big-img/1.jpg">
                                </div>
                            </div>
                            <!-- end product images -->
    ...
    <script>
        ...
        // registrasi gagal
        <?php if(!empty($_SESSION['sw-error'])): ?>
        Swal.fire({
            title: 'error!',
            text: '<?= $_SESSION['sw-error'] ?>',
            icon: 'error',
            confirmButtonText: 'Ok'
        })
        <?php 
        unset($_SESSION['sw-error']); 
        endif; ?>
    </script>
