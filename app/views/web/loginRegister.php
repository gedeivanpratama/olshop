                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            ...
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form class="login" method="post" action="<?= BASEURL .'/Auth/login' ?>">
                                <?php if(!empty($_SESSION['error']['username'])): 
                                        foreach($_SESSION['error']['username'] as $username):?>
                                    ...
                                    <?php if(!empty($_SESSION['error']['password'])): 
                                        foreach($_SESSION['error']['password'] as $password):?>
                                    ...
                                    <button type="submit" class="btn btn-lg btn-submit">Login</button>
                                </form>
                            </div>
                            <!-- End Single Content -->
                            <!-- Start Single Content -->
                            <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                                <form class="login" method="post" action="<?= BASEURL ?>/Auth/register">
                                    <?php if(!empty($_SESSION['error']['username'])): 
                                        foreach($_SESSION['error']['username'] as $username):?>
                                        <p class="text-danger">*<?= $username ?></p>
                                        <?php endforeach;?>
                                    ...
                                    <?php if(!empty($_SESSION['error']['email'])): 
                                        foreach($_SESSION['error']['email'] as $email):?>
