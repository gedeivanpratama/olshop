...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL ?>/css/core.css">
    <!-- Theme shortcodes/elements style -->
    <link rel="stylesheet" href="<?= BASEURL ?>/css/shortcode/shortcodes.css">
    <!-- Theme main style -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-3">  
                            <ul class="menu-extra">
                                ...
                                <li><a href="<?= BASEURL ?>/Auth"><span class="ti-user"></span></a></li>
